        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ul class="breadcrumbs bg-light mb-4">
                    ...
                    <li class="breadcrumbs__item">
                        <a class="breadcrumbs__url" href="/">News</a>
                    </li>
            ...
            <div class="col-md-8">
                ...
                <div class="wrap__article-detail">
                        ...
                        <ul class="list-inline">
                            <li class="list-inline-item">
                                <figure class="image-profile">
                                    <img src="{{ asset('assets/frontend/images/profile2.png')}}" alt="">
                                </figure>
                            </li>
                            <li class="list-inline-item">
                    ...
                    <div class="wrap__article-detail-image mt-4">
                        <figure>
                            <img src="{{ asset('assets/frontend/images/article-slide.jpg')}}" alt="" class="img-fluid">
                        </figure>
                    </div>
                    <div class="wrap__article-detail-content">
                        ...
                        <!-- <figure>
            <img src="{{ asset('assets/frontend/images/article10.jpg')}}" alt="" class="img-fluid">
        </figure> -->
                            ...
                            <aside class="comment-body">
                                <div class="comment-meta">
                                    <div class="comment-author vcard">
                                        <img src="{{ asset('assets/frontend/images/profile2.png')}}" class="avatar" alt="image">
                                        <b class="fn">Sinmun</b>
                            ...
                            <ol class="children">
                                <li class="comment">
                                    <aside class="comment-body">
                                        <div class="comment-meta">
                                            <div class="comment-author vcard">
                                                <img src="{{ asset('assets/frontend/images/profile.png')}}" class="avatar" alt="image">
                                                <b class="fn">Sinmun</b>
                                                <span class="says">says:</span>
                                            </div>
                        ...
                        <div class="item">
                            ...
                            <div class="article__entry">
                                <div class="article__image">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/newsimage9.jpg')}}" alt="" class="img-fluid">
                                    </a>
                                </div>
            ...
            <div class="col-md-4">
                <div class="sidebar-sticky">
                        ...
                        <div class="wrapper__list__article-small">
                            <div class="mb-3">
                                ...
                                <div class="card__post card__post-list">
                                    <div class="image-sm">
                                        <a href="#">
                                            <img src="{{ asset('assets/frontend/images/news6.jpg')}}" class="img-fluid" alt="">
                                        </a>
                                    </div>
                    ...
                    sollicitudin ut est. In fringilla dui dui.
                            ...
                            <div class="mb-3">
                                ...
                                <div class="card__post card__post-list">
                                    <div class="image-sm">
                                        <a href="#">
                                            <img src="{{ asset('assets/frontend/images/news7.jpg')}}" class="img-fluid" alt="">
                                        </a>
                                    </div>
                    ...
                    sollicitudin ut est. In fringilla dui dui.
                            ...
                            <div class="mb-3">
                                ...
                                <div class="card__post card__post-list">
                                    <div class="image-sm">
                                        <a href="#">
                                            <img src="{{ asset('assets/frontend/images/news8.jpg')}}" class="img-fluid" alt="">
                                        </a>
                                    </div>
                    ...
                    <aside class="wrapper__list__article">
                        ...
                        <a href="#">
                            <figure>
                                <img src="{{ asset('assets/frontend/images/banner2.jpg')}}" alt="" class="img-fluid">
                            </figure>
                        </a>
                    </aside>
