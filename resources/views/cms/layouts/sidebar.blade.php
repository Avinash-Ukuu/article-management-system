    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item">
                    <a href="{{ route('cms.dashboard') }}" class="nav-link @if (Route::currentRouteName() == 'cms.dashboard') active @endif">
                ...
                @can('admin', new App\Models\User())
                    <li class="nav-item @if (in_array(Route::currentRouteName(), ['cms.user.index', 'cms.role.index', 'cms.module.index', 'cms.permission.index'])) menu-open @endif">
                        <a href="#" class="nav-link  @if (in_array(Route::currentRouteName(), ['cms.user.index', 'cms.role.index', 'cms.module.index', 'cms.permission.index'])) active @endif">
