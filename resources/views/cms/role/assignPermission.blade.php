...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('cms.role.index') }}">Role List</a></li>
    ...
    <div class="col-sm-12">
        <div class="card card-primary card-outline">
            ...
            {{ Form::open(['url' => route('cms.submitPermission'), 'method' => 'POST', 'onSubmit' => "document.getElementById('submit').disabled=true;"]) }}
