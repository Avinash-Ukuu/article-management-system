        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                @can('superAdmin', new App\Models\User())
                    <div class="card-tools"><a href="{{ route('cms.permission.create') }}"><span class="btn btn-sm btn-info">Add
                                    ...
                                    @can('superAdmin', new App\Models\User())
                                        <td>
                                            <div class="row">
                                                ...
                                                <form
                                                    action="{{ route('cms.permission.destroy', ['permission' => $permission->id]) }}"
                                                    method="post">
                                                    @csrf
                                                    @method('Delete')
