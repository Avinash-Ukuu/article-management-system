...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('cms.user.index') }}">User List</a></li>
    ...
    <div class="col-12">
        <div class="card card-primary card-outline">
            ...
            {{ Form::open(['url' => route('cms.submitRole'), 'method' => 'POST', 'onSubmit' => "document.getElementById('submit').disabled=true;"]) }}
